...
if(mode == 1):
	...
	host = "10.100.53.135"            # Set the server address to variable host
 
	port = 4440               # Sets the variable port to 4446
	...
	query = s.recv(1024)            # Receives data upto 1024 bytes and stores in variables msg
 
	print "Query from remote site : " + query
